...
# export config
name = "Test export"
description = "september GPS1"
from_date = "2021-09-01" # YYYY-MM-DD
to_date = "2021-09-10"
filename = "september"
uniqueId = '1234'
...
def getDeviceID(unique_id):
    
    request_url = f'{base_url}/api/devices?uniqueId={unique_id}'
...
request_url = f"{base_url}/api/reports/route?_dc=1619800977916&deviceId={getDeviceID(uniqueId)}&type=allEvents&from={from_date}T00%3A00%3A00%2B02%3A00&to={to_date}T00%3A00%3A00%2B02%3A00&daily=false&mail=false"
req = urllib.request.urlopen(request_url)
